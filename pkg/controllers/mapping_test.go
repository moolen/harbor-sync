...
var _ = Describe("Mapping", func() {
	...
	Describe("Match", func() {
		...
		It("should create secrets in namespace", func(done Done) {
			...
			ensureHarborSyncConfigWithParams(k8sClient, "my-match-cfg", "platform-team", mapping)
			hscr.mapByMatching(
				mapping,
	...
	Describe("Translate", func() {
		...
		It("should create secrets in namespace", func(done Done) {
			...
			ensureHarborSyncConfigWithParams(k8sClient, "my-translate-cfg", "team-translate-(.*)", mapping)
